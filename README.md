...
| **Vapor Chamber** | Solid   | Orthotropic: firet attemps: 12,000 W/m·K (axial and vertical off the Die), 150 W/m·K perpendicular to the heat pipes(runaway die temps) updated to values states above. (difficult to find accurate values for VC TK) |
